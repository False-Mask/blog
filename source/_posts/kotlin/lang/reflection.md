...
分布和KClassImpl类似
![img_8.png](https://typora-blog-picture.oss-cn-chengdu.aliyuncs.com/blog/img_8.png)
...
每一次引用都会生成一个匿名类
![img_7.png](https://typora-blog-picture.oss-cn-chengdu.aliyuncs.com/blog/img_7.png)
...
一样的套路
![img_9.png](https://typora-blog-picture.oss-cn-chengdu.aliyuncs.com/blog/img_9.png)

这里对于var的引用时mutable 对于val就是...

最后根据super调用,一路点到了老熟人

![img_10.png](https://typora-blog-picture.oss-cn-chengdu.aliyuncs.com/blog/img_10.png)
...
![img_11.png](https://typora-blog-picture.oss-cn-chengdu.aliyuncs.com/blog/img_11.png)
